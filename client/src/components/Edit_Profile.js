        ...
        <div className="content-adapt">
          <div className="container-edit">
            <div className="picture-edit">
              <h1 className="username-edit">{this.props.username}</h1>
              <img src={this.props.imgName} alt={this.props.imgName} className="profile" id="picture" />
              <Link to="/Picture" className="link-edit">Change your picture</Link>
            </div>
              ...
              <form className="wrap-edit-data" onSubmit={this.handleFormSubmit}>
                ...
                <div className="separator-data-edit">
                  ...
                  <div className="form-group inputs-edit">
                    ...
                    <input type="phone" className="form-control" name="phoneForm" id="phone" value={this.state.phone} onChange={(e) => this.handleChangePhone(e)} />
                  </div>
